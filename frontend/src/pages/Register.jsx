        ...
        <div className="flex items-center justify-center h-[calc(100vh-80px)]">
            <form className="w-full max-w-md bg-white shadow-lg rounded-2xl p-8 space-y-6">
                <div className="text-center">
                    <h1 className="text-2xl font-semibold text-gray-700">Create An Account</h1>                </div>
                ...
                <div className="text-center text-gray-500 mt-4 font-semibold">Or register with</div>
